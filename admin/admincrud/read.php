...
{	
	...
	if(empty($usernames) || empty($firstname) || empty($email)) {	
		...
		//updating the table
		$result = mysqli_query($mysqli, "UPDATE users SET username='$username',firstname='$firstname',email='$email' WHERE id=$id");
		
		//redirectig to the display page. In our case, it is userlist.php
...
<center>
        ...
        <div class="container-fluid">
            <div class="row">
				...
				<td><input type="text" name="firstname" readonly value="<?php echo $firstname;?>"></td>
                        </div>  
                        <div class="form-group">
                            <label>Last Name</label>
				<td><input type="text" name="lastname" readonly value="<?php echo $lastname;?>"></td>
                        </div>    						
						<div class="form-group">
                            <label>Email</label>
				...
				<a href="userlist.php"><button id="but" class="float-center submit-button" >Return</button> </a>
